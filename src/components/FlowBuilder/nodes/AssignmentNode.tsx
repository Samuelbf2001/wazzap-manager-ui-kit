...
const hubspotProperties = {
  contact: [
    ...
    // Propiedades personalizadas para WhatsApp
    { value: 'whatsapp_phone_number', label: 'Número de WhatsApp' },
    { value: 'last_whatsapp_activity', label: 'Última Actividad WhatsApp' },
    { value: 'conversation_stage', label: 'Etapa de Conversación' },
    { value: 'lead_quality_score', label: 'Puntuación de Calidad del Lead' },
    { value: 'pain_points', label: 'Puntos de Dolor' },
    { value: 'budget_range', label: 'Rango de Presupuesto' },
    { value: 'decision_timeframe', label: 'Marco Temporal de Decisión' },
    { value: 'conversation_sentiment', label: 'Sentimiento de Conversación' },
    { value: 'products_of_interest', label: 'Productos de Interés' },
    { value: 'preferred_contact_method', label: 'Método de Contacto Preferido' },
    { value: 'timezone', label: 'Zona Horaria' },
    { value: 'language_preference', label: 'Idioma Preferido' },
    { value: 'marketing_source', label: 'Fuente de Marketing' },
    { value: 'lead_score', label: 'Puntuación del Lead' },
    { value: 'engagement_level', label: 'Nivel de Engagement' },
    { value: 'customer_type', label: 'Tipo de Cliente' },
    { value: 'industry', label: 'Industria' },
    { value: 'company_size', label: 'Tamaño de Empresa' },
    { value: 'annual_revenue', label: 'Ingresos Anuales' },
    { value: 'decision_maker', label: 'Tomador de Decisiones' },
    { value: 'influence_level', label: 'Nivel de Influencia' },
    { value: 'urgency_level', label: 'Nivel de Urgencia' },
    { value: 'competitor_mentioned', label: 'Competidor Mencionado' },
    { value: 'follow_up_date', label: 'Fecha de Seguimiento' },
    { value: 'last_contact_date', label: 'Fecha del Último Contacto' },
    { value: 'total_conversations', label: 'Total de Conversaciones' },
    { value: 'avg_response_time', label: 'Tiempo Promedio de Respuesta' },
    { value: 'satisfaction_score', label: 'Puntuación de Satisfacción' },
    { value: 'referral_source', label: 'Fuente de Referencia' },
  ...
  company: [
    ...
    { value: 'state', label: 'Estado/Provincia' },
    { value: 'hubspot_owner_id', label: 'Propietario' },
    // Propiedades personalizadas para empresas
    { value: 'company_size', label: 'Tamaño de Empresa' },
    { value: 'annual_revenue', label: 'Ingresos Anuales' },
    { value: 'employee_count', label: 'Número de Empleados' },
    { value: 'business_type', label: 'Tipo de Negocio' },
    { value: 'founded_year', label: 'Año de Fundación' },
    { value: 'website_url', label: 'URL del Sitio Web' },
    { value: 'linkedin_url', label: 'URL de LinkedIn' },
    { value: 'twitter_url', label: 'URL de Twitter' },
    { value: 'facebook_url', label: 'URL de Facebook' },
    { value: 'instagram_url', label: 'URL de Instagram' },
    { value: 'youtube_url', label: 'URL de YouTube' },
    { value: 'tiktok_url', label: 'URL de TikTok' },
    { value: 'whatsapp_business_number', label: 'Número WhatsApp Business' },
    { value: 'primary_contact_name', label: 'Nombre del Contacto Principal' },
    { value: 'primary_contact_email', label: 'Email del Contacto Principal' },
    { value: 'primary_contact_phone', label: 'Teléfono del Contacto Principal' },
    { value: 'decision_maker_name', label: 'Nombre del Tomador de Decisiones' },
    { value: 'decision_maker_title', label: 'Cargo del Tomador de Decisiones' },
    { value: 'budget_range', label: 'Rango de Presupuesto' },
    { value: 'purchase_timeline', label: 'Cronograma de Compra' },
    { value: 'current_solution', label: 'Solución Actual' },
    { value: 'pain_points', label: 'Puntos de Dolor' },
    { value: 'competitors_mentioned', label: 'Competidores Mencionados' },
    { value: 'lead_source', label: 'Fuente del Lead' },
    { value: 'lead_score', label: 'Puntuación del Lead' },
    { value: 'lifecycle_stage', label: 'Etapa del Ciclo de Vida' },
    { value: 'last_activity_date', label: 'Fecha de Última Actividad' },
    { value: 'total_deals', label: 'Total de Deals' },
    { value: 'total_deal_value', label: 'Valor Total de Deals' },
    { value: 'avg_deal_size', label: 'Tamaño Promedio de Deal' },
    { value: 'customer_since', label: 'Cliente Desde' },
    { value: 'renewal_date', label: 'Fecha de Renovación' },
    { value: 'contract_value', label: 'Valor del Contrato' },
    { value: 'contract_end_date', label: 'Fecha de Fin de Contrato' },
    { value: 'satisfaction_score', label: 'Puntuación de Satisfacción' },
    { value: 'nps_score', label: 'Puntuación NPS' },
    { value: 'churn_risk', label: 'Riesgo de Churn' },
    { value: 'upsell_opportunity', label: 'Oportunidad de Upsell' },
    { value: 'referral_potential', label: 'Potencial de Referencia' },
    { value: 'industry_trends', label: 'Tendencias de la Industria' },
    { value: 'market_position', label: 'Posición en el Mercado' },
    { value: 'growth_stage', label: 'Etapa de Crecimiento' },
    { value: 'funding_status', label: 'Estado de Financiación' },
    { value: 'technology_stack', label: 'Stack Tecnológico' },
    { value: 'integration_requirements', label: 'Requisitos de Integración' },
    { value: 'compliance_requirements', label: 'Requisitos de Cumplimiento' },
    { value: 'security_requirements', label: 'Requisitos de Seguridad' },
    { value: 'scalability_needs', label: 'Necesidades de Escalabilidad' },
    { value: 'support_level', label: 'Nivel de Soporte' },
    { value: 'training_requirements', label: 'Requisitos de Capacitación' },
    { value: 'implementation_timeline', label: 'Cronograma de Implementación' },
    { value: 'success_metrics', label: 'Métricas de Éxito' },
    { value: 'roi_expectations', label: 'Expectativas de ROI' },
    { value: 'notes', label: 'Notas' }
  ],
  ticket: [
